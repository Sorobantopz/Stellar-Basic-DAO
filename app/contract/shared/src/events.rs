...
#[allow(dead_code)]
pub const EVENT_REPLAY_FIELDS: &[&str] = &[
    "event_type_id",
    "ledger_sequence",
    "schema_version",
    "timestamp",
...
pub const EVENT_SCHEMAS: &[EventSchema] = &[
    ...
    EventSchema {
        ...
        topics: &[EVENT_TOPIC_DISPUTE, "DisputeTimeoutSet", "escrow_id"],
        payload_keys: &[
            "action",
            "event_type_id",
            "expires_at",
...
pub fn publish_emergency_mode_activated(env: &Env, admin: Address) {
...
pub fn publish_privacy_toggled(env: &Env, owner: Address, enabled: bool) {
    PrivacyToggledEvent {
        owner,
        enabled,
        event_type_id: ETID_PRIVACY_TOGGLED,
...
#[allow(dead_code)]
pub fn publish_contract_initialized(
    env: &Env,
    admin: Address,
...
#[allow(dead_code)]
pub fn publish_contract_paused(env: &Env, admin: Address, paused: bool) {
    ContractPausedEvent {
        admin,
        event_type_id: ETID_CONTRACT_PAUSED,
        schema_version: EVENT_SCHEMA_VERSION,
...
pub fn publish_contract_upgraded(env: &Env, new_wasm_hash: BytesN<32>, admin: &Address) {
...
pub fn publish_upgrade_started(
    env: &Env,
    admin: &Address,
    old_version: u32,
    new_version: u32,
...
pub fn publish_upgrade_completed(env: &Env, admin: &Address, old_version: u32, new_version: u32) {
...
pub fn publish_contract_migrated(env: &Env, admin: &Address, from_version: u32, to_version: u32) {
...
pub fn publish_escrow_deposited(
    env: &Env,
    commitment: BytesN<32>,
    owner: Address,
    token: Address,
...
pub fn publish_escrow_disputed(env: &Env, commitment: BytesN<32>, arbiter: Address) {
    EscrowDisputedEvent {
        escrow_id: commitment,
        arbiter,
        event_type_id: ETID_ESCROW_DISPUTED,
...
pub fn publish_escrow_refunded(
    env: &Env,
    owner: Address,
    commitment: BytesN<32>,
    token: Address,
...
pub fn publish_aux_indices_cleaned(env: &Env, commitment: BytesN<32>, indices_removed: u32) {
...
pub fn publish_partial_payment(
    env: &Env,
    commitment: BytesN<32>,
    payer: Address,
    token: Address,
...
pub fn publish_escrow_finalized(
    env: &Env,
    commitment: BytesN<32>,
    owner: Address,
    token: Address,
...
pub fn publish_ephemeral_key_registered(
    env: &Env,
...
pub fn publish_stealth_withdrawn(
    env: &Env,
    stealth_address: BytesN<32>,
    recipient: Address,
    token: Address,
...
pub fn publish_stealth_escrow_cleaned(env: &Env, stealth_address: BytesN<32>) {
...
pub fn publish_fee_config_changed(env: &Env, fee_bps: u32) {
...
pub fn publish_platform_wallet_changed(env: &Env, wallet: Address) {
...
pub fn publish_arbiter_vote_cast(
    env: &Env,
    commitment: BytesN<32>,
    arbiter: Address,
...
pub fn dispute_action_symbol(env: &Env, action: crate::types::DisputeExpiryAction) -> Symbol {
    match action {
...
pub fn publish_dispute_timeout_set(
    env: &Env,
    commitment: BytesN<32>,
...
pub fn publish_dispute_auto_resolved(
    env: &Env,
    commitment: BytesN<32>,
    action: crate::types::DisputeExpiryAction,
    recipient: Address,
...
pub fn publish_dispute_expiry_action_set(env: &Env, action: crate::types::DisputeExpiryAction) {
...
pub fn publish_dispute_timeout_config_set(env: &Env, timeout_secs: u64) {
...
pub fn publish_fee_collector_rotated(env: &Env, new_collector: Address, rotation_index: u32) {
...
pub fn publish_per_asset_fee_set(
    env: &Env,
    token: Address,
    fee_bps: u32,
    arbiter_bps: u32,
...
pub fn publish_hook_registered(env: &Env, hook_contract: Address) {
    HookRegisteredEvent {
        hook_contract,
        schema_version: EVENT_SCHEMA_VERSION,
        ledger_sequence: env.ledger().sequence(),
...
pub fn publish_hook_unregistered(env: &Env, hook_contract: Address) {
...
pub fn publish_upgrade_window_set(env: &Env, admin: Address, window_start: u64, window_end: u64) {
...
pub fn publish_pause_flags_changed(
    env: &Env,
    admin: Address,
    flags_enabled: u64,
    flags_disabled: u64,
...
pub fn publish_escrow_cleanup(env: &Env, commitment: BytesN<32>) {
    EscrowCleanupEvent {
        escrow_id: commitment,
        schema_version: EVENT_SCHEMA_VERSION,
        timestamp: env.ledger().timestamp(),
